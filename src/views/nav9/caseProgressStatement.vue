      ...
      <div class="TopForm">
        ...
        <div class="TableList">
          <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border stripe style="width: 100%" :height="total>0?500:100">
            ...
            <el-table-column prop="mobile" label="案件催收员"> </el-table-column>
            <el-table-column prop="content" label="从未跟进"></el-table-column>
            <el-table-column prop="user_id" label="1-3天未跟进"></el-table-column> 
            <el-table-column prop="user_id" label="7-15天未跟进"></el-table-column> 
            <el-table-column prop="user_id" label="16-30天未跟进"></el-table-column> 
            <el-table-column prop="user_id" label="31-45天未跟进"></el-table-column> 
            <el-table-column prop="user_id" label="46-60天未跟进"></el-table-column> 
            <el-table-column prop="user_id" label="60天以上未跟进"></el-table-column> 
          </el-table>
        </div>
