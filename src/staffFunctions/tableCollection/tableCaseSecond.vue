<template>
    <el-table border :data="tableSecond" style="width: 98%">
        ...
        <el-table-column label="创建者" prop="creater" width='69'></el-table-column>
        ...
        <el-table-column prop="record_status" label="呼叫状态" width="149"></el-table-column>
        ...
        <el-table-column label="操作" prop="case_id_num" width='116'>
            <template slot-scope='scope'>
                <el-button round type="success" :disabled='selfInfo.case_status==3||scope.row.id ==""' size='mini' @click="addRemarkFn(scope.row)" >修改催收记录</el-button>
            </template>
        </el-table-column>
    </el-table>
</template>
